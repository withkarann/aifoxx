    ...
    <>
      ...
      <PageWrapper>
        <div className="space-y-6">
          ...
          <a href={tool.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-accent-green text-primary-foreground font-display font-black tracking-widest text-sm px-6 py-3 rounded-[6px] hover:shadow-glow transition-all duration-150">&gt;&gt; OPEN TOOL</a>
