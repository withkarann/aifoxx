        ...
        <div className="flex justify-center gap-6 mt-6">
          {STATS.map((s) => (
            <div key={s.label} className="flex flex-col items-center">
              <span className="font-display font-black text-accent-green text-xl">
                {s.value}
              </span>
        ...
        <div className="space-y-4">
          ...
          {isEmpty ? (
            <div className="bg-bg-elevated border border-border-default rounded-[6px] p-8 text-center">
              <p className="font-display text-accent-green font-black">
                &gt; NO_RESULTS_FOUND
              </p>
              ...
              <button
                ...
                className="font-mono text-xs text-accent-green hover:underline mt-3"
              >
                CLEAR_FILTERS
              </button>
            </div>
