...
| | Count | What it is |
|---|--:|---|
| 🛠️ **AI tools** | 982 | Searchable, filterable catalog with pricing, compliance, and data-handling metadata |
| 🔌 **MCP servers** | 1,979 | Indexed Model Context Protocol servers |
| 🧩 **Claude Code skills** | 1,638 | Indexed Claude Code skills |
| 🛡️ **Trust & Security Reports** | 971 | Per-vendor reports, every certification backed by a verbatim source quote |
